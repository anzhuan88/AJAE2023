...
st.subheader("How did we test the hypothesis of Fancy Resort vs Run-Down Shack")
...
<div style='font-family: Arial, sans-serif; font-size: 16px; margin-bottom: 10px; color: #FFFFFF;'>
    <div>&nbsp; To the closest dollar amount, how much do you usually spend for a pound of steak?</div>
</div>
""", unsafe_allow_html=True)
...
st.caption(
    "Both tracks are identical **except** for the inclusion of the simple reference price reminder."
)
